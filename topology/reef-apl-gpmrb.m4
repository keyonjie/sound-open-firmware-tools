#
# Topology for Apollolake GPRMB board
#
...
#
DAI_CONFIG(SSP, 4, SSP4-Codec, DSP_B, 16,
	DAI_CLOCK(mclk, 24576000, slave),
	DAI_CLOCK(bclk, 6144000, slave),
